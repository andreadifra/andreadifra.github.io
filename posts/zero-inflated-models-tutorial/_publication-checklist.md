...
- Added `references.bib` and explicit citeproc settings under the HTML format. The running preview now renders author-year citations and the bibliography; keep `bibliography: references.bib` local to the post directory.
