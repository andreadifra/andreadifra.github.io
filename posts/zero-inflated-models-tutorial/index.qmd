...
Once a predictor can act through either pathway, we must decide which predictors belong in each component. This is a substantive modelling decision: placing a variable in one formula but not the other restricts which part of the outcome distribution it may change.
