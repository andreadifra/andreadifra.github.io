...
With the models now compared, checked, and interpreted on both component and response scales, the final section turns to the complete argument. It synthesizes why the compact ZINB was retained as a working model, what the modelling sequence taught us, and which limitations should shape its use.
